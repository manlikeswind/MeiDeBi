...
public class MyCollectListViewAdapter extends BaseAdapter{
    ...
    public MyCollectListViewAdapter(List<MyCollectInfo.DataBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(context).load(list.get(position).getStrImgUrl()).config(Bitmap.Config.RGB_565).into(viewHolder.iv);
        viewHolder.tv.setText(list.get(position).getStrUp());
        return convertView;
    }
