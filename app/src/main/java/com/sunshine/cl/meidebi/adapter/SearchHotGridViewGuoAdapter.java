 ...
 */
public class SearchHotGridViewGuoAdapter extends BaseAdapter {

    List<HotStoreGridInfo.DataBean.GuoneiBean> list;
    Context context;

    public SearchHotGridViewGuoAdapter(List<HotStoreGridInfo.DataBean.GuoneiBean> list, Context context) {
        this.list = list;
