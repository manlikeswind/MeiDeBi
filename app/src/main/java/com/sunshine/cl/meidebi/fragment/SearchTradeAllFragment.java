 ...
 */
public class SearchTradeAllFragment extends BaseFragment implements DataCallBack {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_search_trade_all, container, false);
        mRecycler = (RecyclerView) view.findViewById(R.id.search_trade_recyclerView);
        mRefresh = (SwipeRefreshLayout) view.findViewById(R.id.search_trade_swipeRefresh);
