 ...
 */
public class TmallDiscountFragment extends BaseFragment implements DataCallBack {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tmall_discount, container, false);
        mRefresh = (SwipeRefreshLayout) view.findViewById(R.id.tmall_swipeRefresh);
        mRecyler = (RecyclerView) view.findViewById(R.id.tmall_recyclerView);
